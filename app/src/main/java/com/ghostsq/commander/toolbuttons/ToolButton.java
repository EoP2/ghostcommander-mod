...
public class ToolButton {
    ...
    ToolButton( int id_ ) {
        this( id_, "", Tools.getVisibleDefault( id_ ) );
    }
    ToolButton( int id_, String prefix_, boolean visible_default ) {
        id = id_;
        prefix = prefix_ == null ? "" : prefix_;
    ...
    private final String getVisiblePropertyName() {
        return prefix + "show_" + codename;
    }
    private final String getCaptionPropertyName() {
        return prefix + "caption_" + codename;
    }
