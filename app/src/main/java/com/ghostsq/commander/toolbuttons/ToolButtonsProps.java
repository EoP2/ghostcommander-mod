...
public class ToolButtonsProps extends ListActivity
{
	...
	public void onCreate( Bundle bundle ) {
        ...
        mode = getIntent().getIntExtra( EXTRA_MODE, MODE_TOOLBAR );
        setTitle( mode == MODE_ACTION_BAR ? R.string.toolbar_preference : R.string.toolbar_preference );

        if( mode == MODE_ACTION_BAR )
            array.restoreActionBar( sp, this );
        else
