...
public abstract class Tools {
    ...
    public static int getId( String cn ) {
        ...
        if( cn.equals( "hist_back" ) ) return      R.id.hist_back;
        if( cn.equals( "hist_fwd"  ) ) return      R.id.hist_fwd;
    ...
    public static CommanderAdapter.Feature getFeature( int id ) {
        ...
        if( id == R.id.hist_back
         || id == R.id.hist_fwd )     return  CommanderAdapter.Feature.HIST;
    ...
    public static String getCodeName( int id ) {
        ...
        if( id == R.id.hist_back )    return  "hist_back";
        if( id == R.id.hist_fwd )     return  "hist_fwd";
    ...
    public static int getCaptionRId( int id ) {
        ...
        if( id == R.id.hist_back )    return  R.string.hist_back;
        if( id == R.id.hist_fwd )     return  R.string.hist_fwd;
    ...
    public final static String getIcon( int id ) {
        ...
        if( id == R.id.hist_back )    return  "←";
        if( id == R.id.hist_fwd )     return  "→";
        if( id == R.id.swap )         return  "⇌";
