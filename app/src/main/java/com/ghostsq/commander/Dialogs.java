...
public class Dialogs implements DialogInterface.OnClickListener {
    ...
    protected void prepareDialog( int id, Dialog dialog ) {
        ...
        try {
            ...
            if( id == R.id.set_date ) {
                ...
                Button use_now_but = dialog.findViewById( R.id.use_now );
                use_now_but.setOnClickListener( new View.OnClickListener() {
                    @Override
                    public void onClick( View v ) {
                        timestamp = new Date().getTime();
                        edit_date.setText( df.format( timestamp ) );
            ...
            if( id == R.id.about ) {
                if( dlgTitle != null )
                    dlgTitle.setText( R.string.about );
                PackageInfo pi = null;
                try {
            ...
            if( id == FILE_EXIST_DIALOG ) {
                ...
                if( dates_provided && src_size != -1 && dst_size != -1 ) {
                    ...
                    sb.append( "<b>" ).append( owner.getString( R.string.source ) ).append( ":</b><br/>" )
                            .append( "&#xA0;&#xA0;<small>" ).append( owner.getString( R.string.sz_lastmod ) ).append( "</small>&#xA0;" ).append( Utils.formatDate( src_date, owner ) ).append( "<br/>" )
                            .append( "&#xA0;&#xA0;<small>" ).append( owner.getString( R.string.sz_Nbytes ) ).append( "</small>&#xA0;" ).append( String.valueOf( src_size ) ).append( "<br/>" );
                    sb.append( "<b>" ).append( owner.getString( R.string.destination ) ).append( ":</b><br/>" )
                            .append( "&#xA0;&#xA0;<small>" ).append( owner.getString( R.string.sz_lastmod ) ).append( "</small>&#xA0;" ).append( Utils.formatDate( dst_date, owner ) ).append( "<br/>" )
                            .append( "&#xA0;&#xA0;<small>" ).append( owner.getString( R.string.sz_Nbytes ) ).append( "</small>&#xA0;" ).append( String.valueOf( dst_size ) ).append( "<br/>" );
    ...
    private void onPositiveButton( int id ) {
        ...
        if( id == PROGRESS_DIALOG ) {   // hide
            ...
            owner.markBgAsUserHidden( taskId );
            taskId = 0L;
            cancelDialog();
            return;
        }
        ...
        try {
            if( valid && whichButton == DialogInterface.BUTTON_POSITIVE ) {
                ...
                if( dialogId == PROGRESS_DIALOG )
                    ...
                    owner.panels.cancelLogin( which_panel );
                    which_panel = -1;
                }
