...
public class Prefs extends PreferenceActivity implements Preference.OnPreferenceClickListener,
    ...
    protected void onCreate( Bundle savedInstanceState ) {
        try {
            ...
            findPreference( ColorsKeeper.BFG_COLORS ).setOnPreferenceClickListener( this );
            findPreference( ColorsKeeper.ABFG_COLORS ).setOnPreferenceClickListener( this );
            findPreference( ColorsKeeper.ABBG_COLORS ).setOnPreferenceClickListener( this );
            findPreference( ColorsKeeper.TBG_COLORS ).setOnPreferenceClickListener( this );
            ...
            findPreference( "actionbar_buttons_preference" ).setOnPreferenceClickListener( this );
    ...
    public boolean onPreferenceClick( Preference preference ) {
        try {
            ...
            } else if( "actionbar_buttons_preference".equals( pref_key ) ) {
                Intent intent = new Intent( Intent.ACTION_MAIN );
                intent.setClass( this, ToolButtonsProps.class );
                intent.putExtra( ToolButtonsProps.EXTRA_MODE, ToolButtonsProps.MODE_ACTION_BAR );
                startActivity( intent );
    ...
    private void setColorsThumb() {
        try {
            ...
            findPreference( ColorsKeeper.BFG_COLORS ).getIcon().setTint( ck.getColor( ColorsKeeper.BFG_COLORS ) );
            findPreference( ColorsKeeper.ABFG_COLORS ).getIcon().setTint( ck.getColor( ColorsKeeper.ABFG_COLORS ) );
            findPreference( ColorsKeeper.ABBG_COLORS ).getIcon().setTint( ck.getColor( ColorsKeeper.ABBG_COLORS ) );
            findPreference( ColorsKeeper.TBG_COLORS ).getIcon().setTint( ck.getColor( ColorsKeeper.TBG_COLORS ) );
        } catch( Exception e ) {
            Log.e( TAG, "", e );
        }
    }
