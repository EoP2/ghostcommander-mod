...
public final class ColorsKeeper {
    ...
    public  static final String BFG_COLORS = "bfg_color_picker";
    public  static final String ABFG_COLORS = "abfg_color_picker";
    public  static final String ABBG_COLORS = "abbg_color_picker";
    public  static final String TBG_COLORS = "tbg_color_picker";
    public  static final String DIV_COLORS = "div_color_picker";

    private  Context ctx;
    private  SharedPreferences   colorPref = null;
    public   int ttlColor, bgrColor, fgrColor, selColor, sfgColor, curColor, divColor, ufgColor, tbgColor, bfgColor, abfgColor, abbgColor;
    ...
    public class FileTypeColor {
        ...
        public int getDefColor( Context ctx, int i ) {
            ...
            default:return r.getColor( R.color.fgr_drk );
            }
        }
    }
    ...
    public final void setColorsByTheme( String t ) {
        ...
        if( "d".equals( t ) ) {
            ...
            divColor = r.getColor( R.color.div_drk );
            bgrColor = r.getColor( R.color.bgr_drk );
            fgrColor = r.getColor( R.color.fgr_drk );
            curColor = r.getColor( R.color.cur_drk );//0;
            selColor = r.getColor( R.color.sel_drk );
            sfgColor = r.getColor( R.color.sfg_drk );
            ufgColor = r.getColor( R.color.ufg_drk );
            tbgColor = r.getColor( R.color.tbg_drk );
            bfgColor = r.getColor( R.color.bfg_drk );
            abfgColor = r.getColor( R.color.abfg_drk );
            abbgColor = r.getColor( R.color.abbg_drk );
        }
        if( "l".equals( t ) ) {
            ttlColor = r.getColor( R.color.ttl_lgt ); 
            divColor = r.getColor( R.color.div_lgt );
            bgrColor = r.getColor( R.color.bgr_lgt );
            fgrColor = r.getColor( R.color.fgr_lgt );
            curColor = r.getColor( R.color.cur_lgt );//0;
            selColor = r.getColor( R.color.sel_lgt );
            sfgColor = r.getColor( R.color.sfg_lgt );
            ufgColor = r.getColor( R.color.ufg_lgt );
            tbgColor = r.getColor( R.color.tbg_lgt );
            bfgColor = r.getColor( R.color.bfg_lgt );
            abfgColor = r.getColor( R.color.abfg_lgt );
            abbgColor = r.getColor( R.color.abbg_lgt );
        }
    ...
    public final int getColor( String key ) {
        ...
        if( BFG_COLORS.equals( key ) ) return bfgColor;
        if( ABFG_COLORS.equals( key ) ) return abfgColor;
        if( TBG_COLORS.equals( key ) ) return tbgColor;
        if( ABBG_COLORS.equals( key ) ) return abbgColor;
        if( DIV_COLORS.equals( key ) ) return divColor;
        return 0;
    }
    ...
    public final void setColor( String key, int c ) {
        ...
        if( BFG_COLORS.equals( key ) ) bfgColor = c;
        if( ABFG_COLORS.equals( key ) ) abfgColor = c;
        if( TBG_COLORS.equals( key ) ) tbgColor = c;
        if( ABBG_COLORS.equals( key ) ) abbgColor = c;
        if( DIV_COLORS.equals( key ) ) divColor = c;
    }
    ...
    public final void store() {
        ...
        editor.putInt( BFG_COLORS, bfgColor );
        editor.putInt( ABFG_COLORS, abfgColor );
        editor.putInt( TBG_COLORS, tbgColor );
        editor.putInt( ABBG_COLORS, abbgColor );
    ...
    public final void restore() {
        ...
        bfgColor = colorPref.getInt( BFG_COLORS, bfgColor );
        abfgColor = colorPref.getInt( ABFG_COLORS, abfgColor );
        tbgColor = colorPref.getInt( TBG_COLORS, tbgColor );
        abbgColor = colorPref.getInt( ABBG_COLORS, abbgColor );
